...
bool bot1t = UNPRESS, bot2t = UNPRESS, bot3t = UNPRESS;
byte SetBuzzer = 0, SetDisplay = 0, estado = 0, led = 0, bot1 = UNPRESS, bot2 = UNPRESS, bot3 = UNPRESS;
  ...
  if ((digitalRead(BUTTON1) == PRESS)
{
  if (bot1t == PRESS && bot1 == UNPRESS)
  ...
  else if (bot1t == UNPRESS && bot1 == PRESS) bot1 = UNPRESS;
      else bot1t = UNPRESS;
        ...
        if ((digitalRead(BUTTON3) == PRESS)
    {
      ...
      else if (bot3t == UNPRESS && bot3 == PRESS) bot3 = UNPRESS;
          else bot3t = UNPRESS;
